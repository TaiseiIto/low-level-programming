...
isfibonacci:			;unsigned long isfibonacci(unsigned long rdi:n)
				;{
	mov rdx, -2		;
	test rdi, rdx		;
...
.isfibonacci:			;.isfibonacci:
	mov rdi, rax		;
	call isfibonacci		;	rax = isfibonacci(rdi/*parsed integer*/);
.print_uint:			;.print_uint:
	mov rdi, rax		;
	call print_uint		;	print_uint(rdi/*isfibonacci num*/);
